...
public class KameraOnIzleme  implements SurfaceHolder.Callback {
    Camera camera;
    KameraSurfaceGoruntu cameraSurfaceView;
    SurfaceHolder surfaceHolder;
    AndroidKamera mainActivity;
    ...
    public KameraOnIzleme(AndroidKamera androidCamera, KameraSurfaceGoruntu cameraSurfaceView) {
    ...
    Camera.PictureCallback picCallback_RAW = new Camera.PictureCallback() {
    ...
    Camera.PictureCallback picCallback_JPG = new Camera.PictureCallback() {
        ...
        if (camera != null) {
            ...
            try {
                ...
                if (size != null) {
                    ...
                    //parameters.setFocusMode(Camera.Parameters.F);
    ...
    private void initSurfaceView() {
        ...
        ViewGroup.LayoutParams prSurface = cameraSurfaceView.getLayoutParams();
